...
public class influences extends AppCompatActivity {
    ...
    private static String url = "http://papanews.in/PapaNews/getInfluence.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_influences);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            mAdapter = new CustomRecyclerAdapter(influences.this, personUtilsList);
