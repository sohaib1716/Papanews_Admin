...
public class politicsActivity extends AppCompatActivity {
    ...
    private static String url = "http://papanews.in/PapaNews/getPolitics.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.politics_activity);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            mAdapter = new CustomRecyclerAdapter(politicsActivity.this, personUtilsList);
