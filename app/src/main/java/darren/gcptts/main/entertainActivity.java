...
public class entertainActivity extends AppCompatActivity {
    ...
    private static String url = "http://papanews.in/PapaNews/getEntertain.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.entertain_activity);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            mAdapter = new CustomRecyclerAdapter(entertainActivity.this, personUtilsList);
