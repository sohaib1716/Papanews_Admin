...
public class userUploads extends AppCompatActivity {
    ...
    private static String url = "http://papanews.in/PapaNews/getUploads.php";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.user_uploads);
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            mAdapter = new CustomRecyclerAdapter(userUploads.this, personUtilsList);
